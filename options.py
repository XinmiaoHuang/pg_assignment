...
class CustomParser(BaseParser):
    def __init__(self):
        ...
        self.parser.add_argument("--img_size", type=tuple, default=(128, 128, 3))
        self.parser.add_argument("--inputc", type=int, default=18)
        self.parser.add_argument("--posec", type=int, default=18)
        self.parser.add_argument("--dt_inputc", type=int, default=21)
        self.parser.add_argument("--dp_inputc", type=int, default=6)
